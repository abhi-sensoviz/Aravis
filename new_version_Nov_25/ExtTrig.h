...
extern vector<int> CamWd;
extern vector<int> CamHt;

extern vector<int> CamTickFreq;
extern vector<bool> flag;
extern vector<bool> part_received;
extern vector<int> part_id;
...
extern int gImageCounter;
extern int gImageCounter1;
//arv
